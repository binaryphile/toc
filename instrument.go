...
func PanicRecovery[T, R any](panicked *atomic.Int64) call.Decorator[T, R] {
	return func(fn call.Func[T, R]) call.Func[T, R] {
...
func ServiceTiming[T, R any](serviceNs *atomic.Int64, onDuration func(time.Duration)) call.Decorator[T, R] {
	return func(fn call.Func[T, R]) call.Func[T, R] {
